      ...
      <div className="grid gap-8">
        {projects.map((p, i) => (
          <motion.article
            key={p.name}
            variants={scaleIn}
            className="glass border-white/[0.05] relative overflow-hidden rounded-3xl p-6 sm:p-8 group hover:shadow-[var(--shadow-glow)] transition-all duration-500"
          >
            ...
            <div className="grid gap-6 lg:grid-cols-12 relative z-10">
              ...
              <div className="lg:col-span-4 flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="mt-4 text-2xl font-bold tracking-tight text-foreground">{p.name}</h3>
              ...
              <div className="lg:col-span-4 border-t lg:border-t-0 lg:border-l border-border/40 pt-6 lg:pt-0 lg:pl-6">
                <div>
              ...
              <div className="lg:col-span-4 border-t lg:border-t-0 lg:border-l border-border/40 pt-6 lg:pt-0 lg:pl-6 flex flex-col justify-between">
                
                <div>
                  <div className="rounded-2xl bg-surface/40 border border-border/40 p-4">
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-2 rounded-xl bg-surface border border-border hover:border-primary/50 text-foreground font-medium text-xs px-4.5 py-3 cursor-pointer"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-2 rounded-xl bg-primary text-primary-foreground hover:bg-primary/90 font-medium text-xs px-4.5 py-3 cursor-pointer"
                  >
